...
<meta name="generator" content="knowledge-map@{meta.get('skill_version', SCRIPT_VERSION)}">
<style>
...
def render_opml(result: dict) -> str:
    ...
    lines.append("    <ownerName>knowledge-map</ownerName>")
    lines.append(f"    <generator>knowledge-map@{meta.get('skill_version', SCRIPT_VERSION)}</generator>")
